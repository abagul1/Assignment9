...
public class AnimatorTest {
  ...
  public void testMoveOp() {
    ...
    am.motion("R", 1, 200, 200, 50, 100, 255, 0 ,0, 0,
            10, 300, 150, 50 ,100, 255, 0, 0, 0);
  ...
  public void testInsertOp() {
    am = new AnimationModel(0, 0, 500, 500);
    am.insertElement("R", "rectangle");
    am.motion("R", 5, 200, 200, 50, 100, 255, 0 ,0, 0,
  ...
  public void testInsertOpTwoElementsSameTime() {
    ...
    am.motion("R", 5, 200, 200, 50, 100, 255, 0 ,0, 0,
            10, 200, 200, 50 ,100, 255, 0, 0, 0);
    am.motion("C", 6, 440, 70, 120, 60, 0, 0 ,255, 0,
            20, 440, 70, 120 ,60, 0, 0, 255, 0);
    am.executeOperations();
  ...
  public void testChangeColorOp() {
    ...
    am.motion("R", 5, 200, 200, 50, 100, 255, 0 ,0, 0,
            10, 200, 200, 54 ,246, 255, 0, 0, 0);
    am.motion("R", 10, 200, 200, 50, 100, 255, 0 ,0, 0,
            12, 200, 200, 54 ,246, 0, 255, 255, 0);
  ...
  public void testGetVerboseAnimationMove() {
    am = new AnimationModel(0, 0, 500, 500);
    am.insertElement("R", "rectangle");
    am.motion("R", 1, 50, 50, 5, 10, 0, 255,0, 0,
  ...
  public void testMove2() {
    ...
    am.motion("R", 1, 200, 200, 50, 100, 255, 0 ,0, 0,
            10, 300, 150, 50 ,100, 255, 0, 0, 0);
    am.motion("R", 10, 300, 150, 50, 100, 255, 0 ,0, 0,
            13, 34, 27, 50 ,100, 255, 0, 0, 0);
    am.executeOperations();
  ...
  public void testScaleOp2() {
    ...
    am.motion("R", 5, 200, 200, 50, 100, 255, 0 ,0, 0,
            10, 200, 200, 54 ,246, 255, 0, 0, 0);
    am.motion("R", 10, 200, 200, 54, 246, 255, 0 ,0, 0,
            13, 200, 200, 12 ,65, 255, 0, 0, 0);
    am.executeOperations();
