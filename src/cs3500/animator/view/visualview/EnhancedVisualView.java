...
public class EnhancedVisualView extends JFrame implements IView {
  ...
  private JSlider animationScrub;
  ...
  public EnhancedVisualView(IAnimation m) {
    ...
    JSplitPane buttonSlider = new JSplitPane(JSplitPane.VERTICAL_SPLIT, buttonPane, sliderPane);
    buttonSlider.setDividerLocation(20);

    animationScrub = new JSlider(JSlider.HORIZONTAL, 0, m.getMaxTick(), 0);
    sliderPane.add(animationScrub);

    JSplitPane splitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, buttonSlider, aniPane);
